    ...
    return (
        <div className="container">
            <div>
                ...
                <p onClick={() => history.push('/card2GaSelected')}>Card_2Ga: In order to fight tremendous evil, he gained formidable power through body reconstruction, but lost his heart and his redemption.</p>
